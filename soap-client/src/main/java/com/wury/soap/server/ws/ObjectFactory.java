 ...
 * generated in the com.wury.soap.server.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersons_QNAME = new QName("http://ws.server.soap.wury.com/", "getPersons");
    private final static QName _GetPersonsResponse_QNAME = new QName("http://ws.server.soap.wury.com/", "getPersonsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.wury.soap.server.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.server.soap.wury.com/", name = "getPersons")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.server.soap.wury.com/", name = "getPersonsResponse")
